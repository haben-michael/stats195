...
## conceptually similarity; classes form the basis of object-oriented
...
## creating the full FIPS codes. What this means for R processing is
...
## EX: Subset counties to a new data frame "mainland" consisting only of the mainland states. AK and Hawaii state FIPS codes are 02 and 15.
...
counties$state.fips <- as.integer(state.fips[,2])
